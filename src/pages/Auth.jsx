...
import loginImg from '../assets/user-login.webp'
    ...
    <>
      <div style={{ width: '100%', height: '100vh' }} className='d-flex justify-content-center align-items-center mt-5'>
        <div className="container w-75">
          <Link to={'/'} className='fw-bolder text-decoration-none'><i className="fa-solid fa-chevron-left"></i> Back to Home</Link>
          <div className="card shadow p-2 mt-2 mb-5">
            <div className="row align-items-center">
              ...
              <div className="col-lg-6">
                <h1 className='fw-bolder mt-2'>
                  <i className="fa-brands fa-docker"></i> <span className='text-warning pe-1'>Project</span>Fair
                </h1>
