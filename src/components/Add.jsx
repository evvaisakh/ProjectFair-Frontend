...
function Add() {
  ...
  return (
    <>
      <button onClick={handleShow} className="btn"><i className="fa-solid fa-circle-plus me-1"></i>Add New</button>
      <Modal
        size='lg'
        centered
        show={show}
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Upload New Project Details</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div className="row align-items-center">
            ...
            <div className="col-lg-8">
              <div className='mb-2'>
                <input type="text" className='form-control my-2' placeholder='Project Title' value={projectDetails.title}
              ...
              <div className='mb-2'>
                <input type="text" className='form-control my-2' placeholder='Project GitHub Link' value={projectDetails.github}
          ...
          <div>
            <input type="text" className='form-control my-2' placeholder='Project Overview' value={projectDetails.overview}
