      ...
      <div className="d-flex flex-column align-items-center justify-content-center mt-5 shadow"
        ...
        <div className="footer d-flex justify-content-evenly w-100">
          <div style={{ width: '300px' }} className="website">
            <h4 className='fw-bold'><i className="fa-brands fa-docker"></i> Project<span className='text-warning ps-1'>Fair</span></h4>
            <h6>
              Designed and built with all the love in the world by the Luminar Nov-23 Batch
          ...
          <div className="links d-flex flex-column fw-bolder">
            <h4>Links</h4>
          ...
          <div className="guides d-flex flex-column fw-bolder">
            <h4>Guides</h4>
            ...
            <a href={'https://www.w3schools.com/react/react_router.asp'} target='_blank' style={{ textDecoration: 'none', color: 'white' }}> Routing </a>
          </div>
          ...
          <div className="contact">
            ...
            <div className="icons fs-3 d-flex justify-content-between mt-3">
              <Link to={'https://getbootstrap.com/'} style={{ textDecoration: 'none', color: 'white' }}><i className="fa-solid fa-envelope"></i></Link>
              <Link to={'https://getbootstrap.com/'} style={{ textDecoration: 'none', color: 'white' }}><i className="fa-brands fa-x-twitter"></i> </Link>
        ...
        <p className='fw-lighter fst-italic'>Copyright&copy; 2024 Project Fair. Built with React.</p>
      </div>
    </>
  )
}
